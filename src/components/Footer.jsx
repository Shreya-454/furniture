  ...
  return (
    <div className="bg-[#243040] ">
      <div className="max-w-[1320px] mx-auto px-3">
        <div className="flex flex-row flex-wrap -mx-3 py-[87px]">
          <div className="md:w-1/2  px-3 w-full mb-10 md:mb-0" data-aos="fade-right" data-aos-easing="linear"
     data-aos-duration="1500">
            ...
            <p className="md:text-sm text-xs font-roboto font-normal leading-normal text-white max-w-[338px] mb-[23px] ">
          ...
          <div className="md:w-1/2 px-3 w-full">
            <div className="flex flex-wrap flex-row -mx-3">
              <div className="sm:w-1/3 mb-5 sm:mb-5 w-full  px-3" data-aos="fade-down" data-aos-easing="linear"
     data-aos-duration="1500">
                <ul>
     ...
     data-aos-duration="1500">
              ...
              <div className="sm:w-1/3 w-full px-3" data-aos="fade-down" data-aos-easing="linear"
     data-aos-duration="1500">
                <ul>
                  <li className="text-white font-roboto md:text-sm text-xs font-medium border-b  border-[#BD7D41] border-solid w-[130px] mb-[19px]">
                    CATEGORIES
      ...
      <p className=" font-roboto text-white text-center md:text-sm text-xs font-normal leading-normal py-7">
        @copyright{year}
      </p>
    </div>
  );
